        ...
        <div className="flex items-center mt-3">
            ...
            >
                ...
                <g clipPath={`url(#${clipId})`}>
                    <rect x="0" y="0" width={`${widthPercent}%`} height="100%" fill="#FF6C6F" />
                </g>
            </svg>
            <span className="ml-2 text-[18px] font-normal text-black">{clamped.toFixed(1)}</span>
        </div>
    )
}
            ...
            {stores.map((store) => {
                ...
                return (
                    <div key={store.id || name} className="w-full">
                        {/* 이미지 영역 */}
                        <div className="w-full h-60 rounded-2xl bg-search-bg overflow-hidden">
                            {image ? (
                                <img
                                    src={image}
                                    alt={name}
                        ...
                        <div className="flex items-end mt-4 justify-between">
                            <div>
                                ...
                                <p className="text-text text-base font-medium">{address}</p>
