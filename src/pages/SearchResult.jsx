...
export default function SearchResult() {
  ...
  const basicList = useMemo(() => filtered.map(r => ({ id: r.id, name: r.name, address: r.address })), [filtered])
  ...
  return (
    ...
    <div className='w-full h-screen bg-white mt-10 rounded-t-[38px] grid grid-cols-3 gap-20 pt-20 px-20'>
